...
if (isset($_POST['submit']) && ! empty($_POST['student']) ) {
...
<html lang="en">
<head>
	<title>Remove Student - E-School - Online School Management System</title>
		...
		<div class="remove">
			...
			<?php if ( isset ( $status ['success'] ) ) : ?>
				<div class="col-xs-12">
				    ...
				    <p> Student name: <?php echo $student; ?> is now removed! </p>

				</div>

			<?php elseif ( isset ($status ['no_such_student'] )): ?>
				<div class="col-xs-12 ad-error">
					<p><?php echo $student; ?> doesn't exists.</p>
				</div>
			<?php else : ?>
			...
			<div class="center">
				<form class="form-horizontal" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" >
					<div class="form-group">
						<label class="control-label col-sm-5">Enter Student Name:</label>
							<div class="col-sm-7">
