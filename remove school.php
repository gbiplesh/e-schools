...
<html lang="en">
<head>
	<title>Remove School - E-School - Online School Management System</title>
		...
		<div class="remove">
			...
			<?php if ( isset ( $status ['success'] ) ) : ?>
				<div class="col-xs-12">
				    ...
				    <p> School name: <?php echo $school; ?> is now removed! </p>
				</div>

			<?php elseif ( isset ($status ['no_such_school'] )): ?>
				<div class="col-xs-12 ad-error">
					<p>School doesn't exists.</p>
				</div>
			<?php else : ?>
