...
<body>
	...
	<img id="img_1" src="img/img_3.png" width="100%" height="auto">
			    ...
			    <div class="login_box">
		            ...
		            <form class="form-horizontal" action="admin.php" method="post">
						...
						<div class="input_group">
		                	<input class="form-control input-sm" type="text" name="username" class="text" placeholder="Username" />
						</div>

						<div class="input_group">
		                	<input class="form-control input-sm" type="password" name="password" class="text" placeholder="Password" />
						</div>

		                <div id="buttons" class="btn input_group">
			                <input type="submit" name="login" value="Login" class="btn btn-default btn-sm">
			                <input type="submit" name="login" value="Sign Up" class="btn btn-default btn-sm">
		                </div>
		            </form>
			    </div>
			</div>
