<?php
	...
	if (isset($_POST['submit']) && ! empty($_POST['students']) ) {
	$sch = $_POST['students'];

	$_SESSION["students"] = $std;
	}
			...
			<div class="center">
				<form class="form-horizontal" method="post" action="enter staff.php" >
					<div class="form-group">
						<p>Enter Student's Full Name You Want To Edit</p>
						<label class="control-label col-sm-5">Enter Full Name :</label>
							<div class="col-sm-7">
								<input class="form-control" type="text" name="students" placeholder="Full Name">
							</div>
					</div>
