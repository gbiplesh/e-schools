...
<html lang="en">
<head>
	<title>Remove Guardian - E-School - Online School Management System</title>
		...
		<div class="remove">
			...
			<?php if ( isset ( $status ['success'] ) ) : ?>
				<div class="col-xs-12">
				    ...
				    <p> Guardian name: <?php echo $guardian; ?> is now removed! </p>

				</div>

			<?php elseif ( isset ($status ['no_such_guardian'] )): ?>
				<div class="col-xs-12 ad-error">
					<p><?php echo $guardian; ?> doesn't exists.</p>
				</div>
			<?php else : ?>
