<?php
	...
	if (isset($_POST['submit']) && ! empty($_POST['schools']) ) {
	$sch = $_POST['schools'];

	$_SESSION["schools"] = $sch;
	}
...
<body>
	...
	<div class="center">
		<h1>Edit School</h1>
			...
			<div class="center">
				<form class="form-horizontal" method="post" action="enter school.php" >
					<div class="form-group">
						<p>Enter School Name You Want To Edit</p>
						<label class="control-label col-sm-5">Enter School Name :</label>
							<div class="col-sm-7">
								<input class="form-control" type="text" name="schools" placeholder="School Name">
							</div>
					</div>
